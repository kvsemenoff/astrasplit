						...
						<div class="col-md-12">
							<div class="product">
								<div class="product__galery">
									<h1>Сплит система LG SMART S09PMG инверторная</h1>
									
									<div class="product__galery_leftbox">
										<div class="product__galery_img">
											<img src="img/galeryimg1.jpg" alt="">
										</div>
										<div class="product__galery_slider">
											<div class="owl-slidergalery">
												<div class="item">
													<a href="img/galeryimg1.jpg">
														<img src="img/productslider1.jpg" alt="">
													</a>
												</div>
												<div class="item">
													<a href="img/galeryimg1.jpg">
														<img src="img/productslider2.jpg" alt="">
													</a>
												</div>
												<div class="item">
													<a href="img/productslider3.jpg">
														<img src="img/productslider3.jpg" alt="">
													</a>
												</div>
								...
								<div class="product__tabblock">
									...
									<div class="product__tabbox product__tab2">
										<h4>Основные</h4>
										<table class="table">
											<tr>
												<td>Мощность охлаждения</td>
									...
									<div class="product__tabbox product__tab3">
										...
										<div class="product__commentform">
											<form action="#" method="post">
												...
												<div class="product__commentbuttons">
													<label class="checkbox">
														<input class="checkbox__hidden" type="checkbox" name="checkbox-test" checked="checked">
														<span class="checkbox__custom-blue"></span>
														<span class="checkbox__label-blue">Я согласен на обработку моих <a href="#">персональных данных</a></span>
													</label>
									...
									<div class="product__tabbox product__tab4">
										<h4>Основные</h4>
										<table class="table">
											<tr>
												<td>Мощность охлаждения</td>
